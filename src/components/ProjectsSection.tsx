  ...
  const projects = [
    {
      title: "E-Recruitment",
      description:
        "Revolutionary authentication system using zero-knowledge proofs for passwordless, privacy-preserving user verification.",
    ...
    },
    {
      ...
      description:
        "Decentralized exchange protocol enabling anonymous trading while maintaining regulatory compliance through ZK proofs.",
    ...
    },
    {
      title: "E-Exhibition",
      description:
        "Transparent yet anonymous voting system for DAOs and governance, ensuring vote privacy while maintaining verifiability.",
    ...
    },
    {
      ...
      description:
        "Monetize personal data while maintaining complete privacy through advanced zero-knowledge computation protocols.",
      technologies: ["ReactJS", "NodeJS", "MongoDB"],
      status: "Development",
      category: "Business",
    },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Cutting-edge implementations that push the boundaries of technology
            and redefine what's possible in the digital realm.
          </p>
        </div>
